...
if (WIN32)
    list(APPEND ace_for_tao_sources
    ...
    list(APPEND ace_for_tao_sources Dev_Poll_Reactor.cpp)
endif(WIN32)


set(ace_for_tao_templates
    ...
    Unbounded_Queue.cpp
    Unbounded_Set.cppVector_T.cpp
)


set(ace_for_tao_inlines
    Bound_Ptr.inl
    Condition_T.inl
    Guard_T.inl
    Handle_Gobbler.inl
...
file(GLOB ace_for_tao_configs config-*.h)
file(GLOB_RECURSE ace_for_tao_os_include os_include/*)

set(ace_for_tao_headers
    ${ace_for_tao_configs}
    ${ace_for_tao_os_include}
    ACE_export.h
...
file(copy "config-${LOWERCASE_SYSTEM_NAME}.h" config.h)    
