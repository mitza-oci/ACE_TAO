...
set(ACE_FACE_SAFETY "NO" CACHE STRING "")
set_property(CACHE ACE_FACE_SAFETY PROPERTY STRINGS NO BASE EXTENDED)

option(ACE_FACE_DEV "" OFF)

if (NOT ACE_FACE_SAFETY)
  set(ACE_FACE_DEV OFF CACHE BOOL "" FORCE)
endif()
